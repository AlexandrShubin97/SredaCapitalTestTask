...
// SOURCE: - https://gist.github.com/kelvinfok/878e8078df0f22cc998181bf90248b31
final class DatesTimePickerManager: NSObject, UIPickerViewDelegate, UIPickerViewDataSource {

    var didSelectDates: ((_ day: Date, _ startTime: Date, _ endTime: Date) -> Void)?
...
extension Date {
    ...
    static func buildTimeRangeString(day: Date, startTime: Date, endTime: Date) -> String {
